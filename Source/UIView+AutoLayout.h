 ...
 *
 *  @param view The view you want to center the reciever in.
 *
 *  @return An array of `NSLayoutConstraint` objects generated by this method.
 */
 ...
 *  @param peerView The view that the reciever is being pinned to.
 *
 *  @return An array of `NSLayoutConstraint` objects generated by this method.
 */
...
/**
 ...
 @param x     The x attribute of the reciever that should be pinned.
 @param y     The y attribute of the reciever that should be pinned.
